    ...
    <section id="contact" className="py-12 bg-primary-focus">
      <div className="max-w-7xl mx-auto text-center px-4 md:px-8 lg:px-12">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-x-24 mt-12 text-base-100/80 text-lg md:text-xl">
            ...
            <div className="flex flex-col items-center mb-8 md:mb-0">
              <div
                ...
                className="mb-4 block text-base-100 hover:text-accent transition-colors duration-300 cursor-pointer relative"
              >
              ...
              <a
                ...
                className="mb-4 block text-base-100 hover:text-accent transition-colors duration-300"
              >
                <p>📱 {contact.phone}</p>
              </a>
              <p>📍 {contact.address}</p>
            ...
            <div className="flex flex-col items-center md:items-end">
              <p className="text-base-100/80 text-xs mb-2 text-center md:text-right">
                Tu visión, nuestra estrategia. Resultados que escalan.
              </p>
              <p className="text-base-100/80 text-xs text-center md:text-right">
