...
function AppLayout() {
  ...
  else if (location.pathname.includes('profesionales'))
    theme = themes.profesionales
  else if (location.pathname.includes('institucional'))
    theme = themes.institucional
  ...
  return (
    ...
    >
      ...
      <Routes>
        ...
        />
        <Route
          path="/ejemplo-ecommerce"
          element={
            <PageWrapper>
              <EjemploEcommerce theme={themes.ecommerce} />
            </PageWrapper>
          }
        />
        <Route
          path="/ejemplo-profesionales"
          element={
            <PageWrapper>
              <EjemploProfesionales theme={themes.profesionales} />
            </PageWrapper>
          }
        />
        <Route
          path="/ejemplo-institucional"
          element={
            <PageWrapper>
              <EjemploInstitucional theme={themes.institucional} />
            </PageWrapper>
          }
        />
      </Routes>
